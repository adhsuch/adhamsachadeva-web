// Lucide-style inline SVG icons (stroke 1.75, 24x24, currentColor).
// Centralised so every icon shares one visual language.
...
// Map skill category -> icon component.
...
// Map contact label -> icon component.
